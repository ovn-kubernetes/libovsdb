...
selectOps, queryID, err := ovs.Where(&MyLogicalSwitch{}).Select()
// ...
// 2. Execute transaction
reply, err := ovs.Transact(ctx, selectOps...)
// ...
// 3. Parse result
err = ovs.GetSelectResults(selectOps, reply, map[string]interface{}{
	queryID: &allSwitches,
})
// ...
```
...
// 1. Generate Op
selectOps, queryID, err := ovs.Where(ls).Select()
// ...
...
selectOps, queryID, err := ovs.WhereAll(lsModel, cond1, cond2).Select()
// ...
// 2. Transact and parse
reply, err := ovs.Transact(ctx, selectOps...)
err = ovs.GetSelectResults(selectOps, reply, map[string]interface{}{
	queryID: &specificSwitches,
})
// ...
```
...
selectOps, queryID, err := ovs.WhereAny(lsModel, cond1, cond2).Select()
// ...
// 2. Transact and parse
reply, err := ovs.Transact(ctx, selectOps...)
// GetSelectResults will parse all results associated with the queryID
// and populate them into the single target slice.
err = ovs.GetSelectResults(selectOps, reply, map[string]interface{}{
	queryID: &specificSwitches,
})
// ...
...
selectOps, queryID, err := ovs.Where(&MyLogicalSwitch{Name: "sw1"}).Select("name", "ports")
```
