...
`
		...
		{
			name: "with column dict",
			extend: func(tmpl *template.Template, data TableTemplateData) {
				data.WithColumnDict(true)
			},
			expected: `// Code generated by "libovsdb.modelgen"
// DO NOT EDIT.
...
// AtomicTableColumns represents the columns defined in the AtomicTable model.
const (
	AtomicTableColumnUUID      = "_uuid"
	AtomicTableColumnEventType = "event_type"
	AtomicTableColumnFloat     = "float"
	AtomicTableColumnInt       = "int"
	AtomicTableColumnProtocol  = "protocol"
	AtomicTableColumnStr       = "str"
)
